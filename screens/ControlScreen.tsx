...
export default function ControlScreen({
  ...
  const connDotColor =
    ...
    connStatus === 'offline' ? Colors.red   : Colors.text3;
        ...
        <View style={styles.lampSection}>
          ...
          <View style={styles.progressTrack}>
            <Animated.View style={[styles.progressFill, {
              width: progressWidth,
              backgroundColor: activeEffect ? Colors.purple : colorCss,
        ...
        {!hasColor && !hasEffects && (
          <View style={styles.infoNote}>
            ...
            <Text style={styles.infoNoteText}>
              Bu cihaz tek renkli LED veya ampul modülü olarak yapılandırılmış.
              Renk ve efekt kontrolü bu cihaz tipi için desteklenmiyor.
            </Text>
          </View>
        )}

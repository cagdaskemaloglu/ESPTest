...
function getPrivacyContent(lang: 'tr' | 'en'): Section[] {
  if (lang === 'tr') return [
    ...
    { type: 'body', text: 'Torva Smart Light, ESP32 tabanlı akıllı LED cihazlarınızı yerel Wi-Fi ağınız üzerinden kontrol etmenizi sağlayan bir mobil uygulamadır.' },
  ...
  return [
    ...
    { type: 'body', text: 'Torva Smart Light is a mobile application that lets you control your ESP32-based smart LED devices over your local Wi-Fi network.' },
...
function getTermsContent(lang: 'tr' | 'en'): Section[] {
  if (lang === 'tr') return [
    ...
    { type: 'body', text: 'Torva Smart Light, ESP32 tabanlı LED cihazlarını yerel Wi-Fi ağı üzerinden kontrol etmek için tasarlanmıştır.' },
  ...
  return [
    ...
    { type: 'body', text: 'Torva Smart Light is designed to control ESP32-based LED devices over a local Wi-Fi network.' },
